...
namespace MultiThreading.Task3.MatrixMultiplier.Tests
{
    ...
    public class MultiplierTest
    {
        ...
        public void ParallelEfficiencyTest()
        {
            ...
            //Done: Implemented in MultiThreading.Task3,MatrixMultiplier.Tests.Benchmark project
            //Result: When the size of matrix is about to 30, the parallel multiplication becomes more effective than the reqular one.
